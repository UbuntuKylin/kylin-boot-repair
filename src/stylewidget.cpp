...
StyleWidget::StyleWidget(StyleWidgetAttribute swa, QString dialogTitleText, bool isDialog )
{
    ...
    this->setWindowIcon(QIcon(":/data/main.png"));
...
void StyleWidget::myStyle(StyleWidgetAttribute swa)
{
    ...
    body = new QWidget;//窗体
    body->setFixedHeight(this->height()-title->height());
...
void StyleWidget::ThemeChooseForWidget(QString str)
{
    ...
    if("ukui-dark" == str || "ukui-black" == str)
    {
        ...
        QString bodyStyleSheet="StyleWidget #body{background-color:rgba(0,0,0,1);border-bottom-left-radius:"+QString::number(local_swa.radius)+
                                "px;border-bottom-right-radius:"+QString::number(local_swa.radius)+"px;}";
        title->setStyleSheet("StyleWidget #title{background-color:rgba(0,0,0,1);border-top-left-radius:"
